    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social_plugin', models.CharField(max_length=250, verbose_name='social plugin', choices=[(b'edsa_facebook_fanpage', b'Facebook Fanpage'), (b'edsa_wordpress_rss', b'Wordpress RSS'), (b'edsa_linkedin', b'LinkedIn Company'), (b'edsa_youtube_search', b'Youtube search'), (b'edsa_instagram', b'Instagram'), (b'edsa_twitter', b'Twitter')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social_type', models.CharField(default=b'edsa_article', max_length=250, verbose_name='social plugin', choices=[(b'edsa_article', b'Article'), (b'edsa_facebook_fanpage', b'Facebook Fanpage'), (b'edsa_wordpress_rss', b'Wordpress RSS'), (b'edsa_linkedin', b'LinkedIn Company'), (b'edsa_youtube_search', b'Youtube search'), (b'edsa_instagram', b'Instagram'), (b'edsa_twitter', b'Twitter')])),
                ...
                ('image', filer.fields.image.FilerImageField(default=None, to='filer.Image', max_length=255, blank=True, null=True, verbose_name='image')),
                ('tags', taggit.managers.TaggableManager(to='taggit.Tag', through='taggit.TaggedItem', blank=True, help_text='A comma-separated list of tags.', verbose_name='Tags')),
                ('thumbnail', filer.fields.image.FilerImageField(related_name='+', default=None, to='filer.Image', max_length=255, blank=True, null=True, verbose_name='thumbnail')),
            ],
            options={
